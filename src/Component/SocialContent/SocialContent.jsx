...
const SocialContent = () => {
  return (
    <section className="w-full  bg-slate-100  my-10 py-7  flex flex-col items-center justify-center">
      <div className='container'>


        <div className="w-full flex flex-row items-start justify-center max-w-full">
          <h1 className="m-0 mb-7  text-inherit leading-[2.625rem] font-bold font-inherit  mq450:text-[1.5rem] mq450:leading-[1.563rem] leptop:text-[2rem] mq825:leading-[2.125rem]">
            Lorem Ipsum Is A Dummy Text
          </h1>
        </div>
        <div className="grid grid-cols-6 grid-rows-6 gap-4 items-start">
